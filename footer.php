            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 pe-4">
                    <div class="footer-about">
                        ...
                        <p class="mt-3 mb-3 white">
                            Explore the amazing corners of Sri Lanka with us. We organize unforgettable tours that will
                            give you vivid impressions and unique emotions.
                        </p>
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 mb-4">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="tuors.php">Tours</a></li>
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 mb-4">
                    <div class="footer-links">
                        <h3 class="white">directions</h3>
                        <ul>
                            <li><a href="destinations.php">ELLA</a></li>
                            <li><a href="destinations.php">NUWARA ELIA</a></li>
                            <li><a href="destinations.php">KANDY</a></li>
                            <li><a href="destinations.php">Galle</a></li>
                            <li><a href="destinations.php">Horton Plains</a></li>
                            <li><a href="destinations.php">Arugambay</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="copyright-inner rounded p-3 d-md-flex align-items-center justify-content-between">
                <div class="copyright-text">
                    <p class="m-0 white"><?php echo date("Y"); ?><span style="color:#fdc703 "> All rights
                            reserved.</span> Designed and created by <a href="https://promodesoftware.com/"
...
<!-- WhatsApp Button -->
<a href="<?php echo $socialmedia['whatsapp']; ?>" target="_blank" class="whatsapp-button"
    title="Chat with us on WhatsApp">
    <img src="images/whatsapp.png" alt="WhatsApp Chat">
</a>

<!-- Telegram Button -->
<a href="<?php echo $socialmedia['telegram']; ?>" target="_blank" class="telegram-button"
