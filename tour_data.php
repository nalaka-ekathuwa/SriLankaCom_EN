                ...
                <div class="breadcrumb-content text-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-block">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="tours.php">Туры</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Детали тура</li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div id="highlight">
                    <div class="single-full-title border-b mb-2 pb-2">
                        <div class="single-title text-center">
                            ...
                            <div class="rating-main">
                                <p class="mb-0 me-2 d-inline-block"><i class="icon-location-pin"></i> <?php echo $tour_data['place']; ?></p>
                    ...
                    <div class="tour-includes mb-4">
                        <table>
                            <tbody>
                                <tr>
                                    <td><i class="fa fa-hourglass pink mr-1" aria-hidden="true"></i> <?php echo $tour_data['days']; ?></td>
                                    <!-- <td><i class="fa fa-clock-o pink mr-1" aria-hidden="true"></i> 2 Days</td> -->

                                    <td><i class="fa fa-users pink mr-1" aria-hidden="true"></i> <?php echo $tour_data['people']; ?></td>
                                    <!-- <td><i class="fa fa-group pink mr-1" aria-hidden="true"></i> Max: 16, min: 8 people</td> -->


                                    <td><i class="fa fa-calendar-check pink mr-1" aria-hidden="true"></i> <?php echo $tour_data['period']; ?></td>
                                    <!-- <td><i class="fa fa-calendar pink mr-1" aria-hidden="true"></i> 2 days</td> -->
                                </tr>
                                <tr>
                                    <td><i class="fa fa-user pink mr-1" aria-hidden="true"></i> <?php echo $tour_data['min_age']; ?></td>
                                    <!-- <td><i class="fa fa-user pink mr-1" aria-hidden="true"></i> Min Age: 5+</td> -->

                                    <td><i class="fa fa-map-signs pink mr-1" aria-hidden="true"></i> <?php echo $tour_data['pickup']; ?></td>
                                    <!-- <td><i class="fa fa-map-signs pink mr-1" aria-hidden="true"></i> Pickup: Airport</td> -->

                                    <td><i class="fa fa-language pink mr-1" aria-hidden="true"></i> <?php echo $tour_data['language']; ?></td>
